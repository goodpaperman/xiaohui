...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
   ...
   if ( GetMDIClient().GetFileName().IsEmpty() )
   {
      COLORMAP clrMap[] = { RGB(192,192,192), ::GetSysColor( COLOR_APPWORKSPACE ),
                            RGB(255,255,255), ::GetSysColor( COLOR_3DHIGHLIGHT ),
                            RGB(0,0,0), ::GetSysColor( COLOR_3DSHADOW ) 
                        };
      GetMDIClient().SetBitmap( IDB_BITMAP1, (COLORMAP*)&clrMap, 2 );
   }
	return 0;
}
