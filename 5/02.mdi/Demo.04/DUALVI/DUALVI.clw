...
NewFileInclude2=#include "DUALVI.h"
LastPage=0
...
Resource3=IDR_DUALVITYPE

[CLS:CDUALVIApp]
Type=0
HeaderFile=DUALVI.h
ImplementationFile=DUALVI.cpp
Filter=N

[CLS:CDUALVIDoc]
Type=0
HeaderFile=DUALVIDoc.h
ImplementationFile=DUALVIDoc.cpp
Filter=N

[CLS:CDUALVIView]
Type=0
HeaderFile=DUALVIView.h
ImplementationFile=DUALVIView.cpp
Filter=C
