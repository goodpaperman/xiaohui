...
void CCustToolBarTestView::OnContextMenu(CWnd*, CPoint point)
{
	theApp.ShowPopupMenu (CG_IDR_POPUP_CUST_TOOL_BAR_TEST_VIEW, point, this);
}

void CCustToolBarTestView::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
	theApp.OnViewDoubleClick (iIdTestView);
}
