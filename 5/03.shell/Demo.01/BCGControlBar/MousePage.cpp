...
//*************************************************************************************************
void CMousePage::OnSelchangeListOfCommands() 
{
...
//*************************************************************************************************
void CMousePage::OnItemchangedListViews(NMHDR* pNMHDR, LRESULT* pResult) 
{
	ASSERT (g_pMouseManager != NULL);
...
//*************************************************************************************************
void CMousePage::EnableDblClickControls (BOOL bEnable)
{
...
//*************************************************************************************************
BOOL CMousePage::SelectCommand (UINT uiCmd)
{
	//-------------------------------
