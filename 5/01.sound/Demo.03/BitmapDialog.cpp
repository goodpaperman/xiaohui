...
void CBitmapDialog::CommonConstruct()
{
	...
	//m_HollowBrush.CreateHatchBrush(HS_DIAGCROSS, ::GetSysColor(COLOR_WINDOW));
	VERIFY(m_brEditBrush.CreateSolidBrush(GetSysColor(COLOR_BTNFACE)));
	//static CBitmap patbmp;
	//patbmp.LoadBitmap(IDB_PATTERN);
	//m_brEditBrush.CreatePatternBrush(&patbmp);

	//m_crStaticText = RGB(0,0,0);
