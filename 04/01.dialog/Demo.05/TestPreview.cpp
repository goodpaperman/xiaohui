// TestPreview.cpp : Defines the class behaviors for the application.
//
...
BOOL CTestPreviewApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_TESTPRTYPE,
		RUNTIME_CLASS(CTestPreviewDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CTestPreviewView));
...
void CTestPreviewApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CTestPreviewApp message handlers
