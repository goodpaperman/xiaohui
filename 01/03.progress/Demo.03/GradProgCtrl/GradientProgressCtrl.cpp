...
void CGradientProgressCtrl::OnPaint() 
{
	...
	float maxWidth((float)(m_nCurrentPosition - m_nLower)/(float)(m_nUpper - m_nLower) * (float)rectClient.right);
	...
	{
		CString percent;
		percent.Format("%.0f%%", 100.0f*(float)(m_nCurrentPosition - m_nLower)/(float)(m_nUpper - m_nLower));
