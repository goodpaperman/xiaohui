...
BEGIN_MESSAGE_MAP(CCTestProgressBarDlg, CDialog)
	...
	//}}AFX_MSG_MAP
    ON_BN_CLICKED(IDC_CLR_TEXT, OnBtnText) 
END_MESSAGE_MAP()
...
BOOL CCTestProgressBarDlg::OnInitDialog()
{
    ...
    m_cClrText.SetTrackSelection(TRUE); 
    m_cClrStart.SetSelectionMode(CP_MODE_TEXT); 
...
void CCTestProgressBarDlg::OnTest() 
{
	...
	m_cProgress.SetRange(m_nRange/2, m_nRange);
    //m_cProgress.SetRange(5000, 10000); 
...
void CCTestProgressBarDlg::OnBtnText()
{
    m_cClrText.GetColour(); 
}