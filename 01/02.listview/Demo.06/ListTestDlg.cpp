...
BOOL CListTestDlg::OnInitDialog()
{
    ...
    m_list.AddItem("nihaoma", 0); 
    m_list.AddItem("wohenhao", 1); 
    m_list.AddItem("nine", 2); 
    m_list.AddItem("woyeshi", 3); 

    m_list.SetViewStyle(LVS_SMALLICON); //LVS_ICON); //LVS_REPORT); 
    int nStyle = m_list.GetViewStyle(); 
    TRACE("ViewStyle: %x\n", nStyle); 
