...
BEGIN_MESSAGE_MAP(CPushPinButton, CButton)   
  ...
  ON_WM_CREATE()
  //ON_NOTIFY_REFLECT_EX(BN_CLICKED, OnClick) 
...
int CPushPinButton::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
//BOOL CPushPinButton::OnClick(NMHDR* pNMHDR, LRESULT* pResult)
//{
//    ProcessClick(); 
//    *pResult = 0; 
//    return TRUE; 
